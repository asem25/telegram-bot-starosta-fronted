...
@Component
public class ImNotStarostaCommand implements BotCommand {
    ...
    public boolean canHandle(Message message) {
        return "Я не староста".equalsIgnoreCase(message.getText().trim());
    }
    ...
    public CompletableFuture<Void> execute(Message message) {
        ...
        profileService.refuseToBeStarosta(chatId, message.getFrom().getUserName());
